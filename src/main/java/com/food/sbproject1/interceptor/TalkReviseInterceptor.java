...
import com.food.sbproject1.talk.TalkVO;

@Component
public class TalkReviseInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(memberVO != null) {
			...
			talkVO.setNum(num);
			talkVO = talkMapper.getTalkOne(talkVO);
			
			if(memberVO.getId().equals(talkVO.getWriter())) {
				result = true;
			}else {
